// @SOURCE:/Users/mingqi/git/climate-service-backend/conf/routes
// @HASH:c5e73696c4445a04ce6617ca918da742dbbec72e
// @DATE:Wed Oct 14 21:51:32 PDT 2015
...
// @LINE:90
private[this] lazy val controllers_DatasetController_getMostKPopularDatasets60_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("dataset/getMostKPopularDatasets/"),DynamicPart("k", """[^/]+""",true))))
private[this] lazy val controllers_DatasetController_getMostKPopularDatasets60_invoker = createInvoker(
play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.DatasetController]).getMostKPopularDatasets(fakeValue[Integer]),
HandlerDef(this.getClass.getClassLoader, "", "controllers.DatasetController", "getMostKPopularDatasets", Seq(classOf[Integer]),"GET", """""", Routes.prefix + """dataset/getMostKPopularDatasets/$k<[^/]+>"""))
        

// @LINE:93
private[this] lazy val controllers_ParameterController_getAllParameters61_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/getAllParameters/json"))))
private[this] lazy val controllers_ParameterController_getAllParameters61_invoker = createInvoker(
...
// @LINE:94
private[this] lazy val controllers_ParameterController_getParameterByName62_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/getParameter/service/"),DynamicPart("id", """[^/]+""",true),StaticPart("/name/"),DynamicPart("name", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_ParameterController_getParameterByName62_invoker = createInvoker(
...
// @LINE:95
private[this] lazy val controllers_ParameterController_getParameterById63_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/getParameter/id/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_ParameterController_getParameterById63_invoker = createInvoker(
...
// @LINE:96
private[this] lazy val controllers_ParameterController_addParameter64_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/addParameter"))))
private[this] lazy val controllers_ParameterController_addParameter64_invoker = createInvoker(
...
// @LINE:97
private[this] lazy val controllers_ParameterController_updateParameterById65_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/updateParameter/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_ParameterController_updateParameterById65_invoker = createInvoker(
...
// @LINE:98
private[this] lazy val controllers_ParameterController_updateParameterByName66_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/updateParameter/name/"),DynamicPart("oldName", """[^/]+""",true))))
private[this] lazy val controllers_ParameterController_updateParameterByName66_invoker = createInvoker(
...
// @LINE:99
private[this] lazy val controllers_ParameterController_deleteParameterByName67_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("parameter/deleteParameter/service/"),DynamicPart("id", """[^/]+""",true),StaticPart("/name/"),DynamicPart("name", """[^/]+""",true))))
private[this] lazy val controllers_ParameterController_deleteParameterByName67_invoker = createInvoker(
...
// @LINE:102
private[this] lazy val controllers_JournalPublicationController_getAllJournalPublications68_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("journalPublication/getAllJournalPublications/json"))))
private[this] lazy val controllers_JournalPublicationController_getAllJournalPublications68_invoker = createInvoker(
...
// @LINE:103
private[this] lazy val controllers_JournalPublicationController_getJournalPublicationById69_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("journalPublication/getJournalPublication/id/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_JournalPublicationController_getJournalPublicationById69_invoker = createInvoker(
...
// @LINE:104
private[this] lazy val controllers_JournalPublicationController_addJournalPublication70_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("journalPublication/addJournalPublication"))))
private[this] lazy val controllers_JournalPublicationController_addJournalPublication70_invoker = createInvoker(
...
// @LINE:105
private[this] lazy val controllers_JournalPublicationController_updateJournalPublicationById71_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("journalPublication/updateJournalPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_JournalPublicationController_updateJournalPublicationById71_invoker = createInvoker(
...
// @LINE:106
private[this] lazy val controllers_JournalPublicationController_deleteJournalPublicationById72_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("journalPublication/deleteJournalPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_JournalPublicationController_deleteJournalPublicationById72_invoker = createInvoker(
...
// @LINE:109
private[this] lazy val controllers_BookPublicationController_getAllBookPublications73_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookPublication/getAllBookPublications/json"))))
private[this] lazy val controllers_BookPublicationController_getAllBookPublications73_invoker = createInvoker(
...
// @LINE:110
private[this] lazy val controllers_BookPublicationController_getBookPublicationById74_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookPublication/getBookPublication/id/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_BookPublicationController_getBookPublicationById74_invoker = createInvoker(
...
// @LINE:111
private[this] lazy val controllers_BookPublicationController_addBookPublication75_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookPublication/addBookPublication"))))
private[this] lazy val controllers_BookPublicationController_addBookPublication75_invoker = createInvoker(
...
// @LINE:112
private[this] lazy val controllers_BookPublicationController_updateBookPublicationById76_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookPublication/updateBookPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_BookPublicationController_updateBookPublicationById76_invoker = createInvoker(
...
// @LINE:113
private[this] lazy val controllers_BookPublicationController_deleteBookPublicationById77_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookPublication/deleteBookPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_BookPublicationController_deleteBookPublicationById77_invoker = createInvoker(
...
// @LINE:116
private[this] lazy val controllers_BookChapterPublicationController_getAllBookChapterPublications78_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookChapterPublication/getAllBookPublications/json"))))
private[this] lazy val controllers_BookChapterPublicationController_getAllBookChapterPublications78_invoker = createInvoker(
...
// @LINE:117
private[this] lazy val controllers_BookChapterPublicationController_getBookChapterPublication79_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookChapterPublication/getBookPublication/id/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_BookChapterPublicationController_getBookChapterPublication79_invoker = createInvoker(
...
// @LINE:118
private[this] lazy val controllers_BookChapterPublicationController_addBookChapterPublication80_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookChapterPublication/addBookPublication"))))
private[this] lazy val controllers_BookChapterPublicationController_addBookChapterPublication80_invoker = createInvoker(
...
// @LINE:119
private[this] lazy val controllers_BookChapterPublicationController_updateBookChapterPublication81_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookChapterPublication/updateBookPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_BookChapterPublicationController_updateBookChapterPublication81_invoker = createInvoker(
...
// @LINE:120
private[this] lazy val controllers_BookChapterPublicationController_deleteBookChapterPublication82_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("BookChapterPublication/deleteBookPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_BookChapterPublicationController_deleteBookChapterPublication82_invoker = createInvoker(
...
// @LINE:123
private[this] lazy val controllers_ConferencePublicationController_getAllConferencePublications83_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ConferencePublication/getAllBookPublications/json"))))
private[this] lazy val controllers_ConferencePublicationController_getAllConferencePublications83_invoker = createInvoker(
...
// @LINE:124
private[this] lazy val controllers_ConferencePublicationController_getConferencePublication84_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ConferencePublication/getBookPublication/id/"),DynamicPart("id", """[^/]+""",true),StaticPart("/json"))))
private[this] lazy val controllers_ConferencePublicationController_getConferencePublication84_invoker = createInvoker(
...
// @LINE:125
private[this] lazy val controllers_ConferencePublicationController_addConferencePublication85_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ConferencePublication/addBookPublication"))))
private[this] lazy val controllers_ConferencePublicationController_addConferencePublication85_invoker = createInvoker(
...
// @LINE:126
private[this] lazy val controllers_ConferencePublicationController_updateConferencePublication86_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ConferencePublication/updateBookPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_ConferencePublicationController_updateConferencePublication86_invoker = createInvoker(
...
// @LINE:127
private[this] lazy val controllers_ConferencePublicationController_deleteConferencePublication87_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("ConferencePublication/deleteBookPublication/id/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_ConferencePublicationController_deleteConferencePublication87_invoker = createInvoker(
...
// @LINE:130
private[this] lazy val controllers_UserController_getUser88_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_UserController_getUser88_invoker = createInvoker(
...
// @LINE:131
private[this] lazy val controllers_UserController_addUser89_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/add"))))
private[this] lazy val controllers_UserController_addUser89_invoker = createInvoker(
...
// @LINE:132
private[this] lazy val controllers_UserController_updateUser90_route = Route("PUT", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/update/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_UserController_updateUser90_invoker = createInvoker(
...
// @LINE:133
private[this] lazy val controllers_UserController_deleteUser91_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/delete/"),DynamicPart("id", """[^/]+""",true))))
private[this] lazy val controllers_UserController_deleteUser91_invoker = createInvoker(
...
// @LINE:134
private[this] lazy val controllers_UserController_getAllUsers92_route = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/getAllUsers/json"))))
private[this] lazy val controllers_UserController_getAllUsers92_invoker = createInvoker(
...
// @LINE:135
private[this] lazy val controllers_UserController_isUserValid93_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/isUserValid"))))
private[this] lazy val controllers_UserController_isUserValid93_invoker = createInvoker(
...
// @LINE:136
private[this] lazy val controllers_UserController_isEmailExisted94_route = Route("POST", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/isEmailExisted"))))
private[this] lazy val controllers_UserController_isEmailExisted94_invoker = createInvoker(
...
// @LINE:137
private[this] lazy val controllers_UserController_deleteUserByUserNameandPassword95_route = Route("DELETE", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/delete/userName/"),DynamicPart("userName", """[^/]+""",true),StaticPart("/password/"),DynamicPart("password", """[^/]+""",true))))
private[this] lazy val controllers_UserController_deleteUserByUserNameandPassword95_invoker = createInvoker(
...
// @LINE:90
case controllers_DatasetController_getMostKPopularDatasets60_route(params) => {
   call(params.fromPath[Integer]("k", None)) { (k) =>
        controllers_DatasetController_getMostKPopularDatasets60_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.DatasetController]).getMostKPopularDatasets(k))
   }
}
        

// @LINE:93
case controllers_ParameterController_getAllParameters61_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_ParameterController_getAllParameters61_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).getAllParameters(format))
   }
}
        

// @LINE:94
case controllers_ParameterController_getParameterByName62_route(params) => {
   call(params.fromPath[Long]("id", None), params.fromPath[String]("name", None), Param[String]("format", Right("json"))) { (id, name, format) =>
        controllers_ParameterController_getParameterByName62_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).getParameterByName(id, name, format))
   }
}
        

// @LINE:95
case controllers_ParameterController_getParameterById63_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_ParameterController_getParameterById63_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).getParameterById(id, format))
   }
}
        

// @LINE:96
case controllers_ParameterController_addParameter64_route(params) => {
   call { 
        controllers_ParameterController_addParameter64_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).addParameter)
   }
}
        

// @LINE:97
case controllers_ParameterController_updateParameterById65_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_ParameterController_updateParameterById65_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).updateParameterById(id))
   }
}
        

// @LINE:98
case controllers_ParameterController_updateParameterByName66_route(params) => {
   call(params.fromPath[String]("oldName", None)) { (oldName) =>
        controllers_ParameterController_updateParameterByName66_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).updateParameterByName(oldName))
   }
}
        

// @LINE:99
case controllers_ParameterController_deleteParameterByName67_route(params) => {
   call(params.fromPath[Long]("id", None), params.fromPath[String]("name", None)) { (id, name) =>
        controllers_ParameterController_deleteParameterByName67_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ParameterController]).deleteParameterByName(id, name))
   }
}
        

// @LINE:102
case controllers_JournalPublicationController_getAllJournalPublications68_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_JournalPublicationController_getAllJournalPublications68_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.JournalPublicationController]).getAllJournalPublications(format))
   }
}
        

// @LINE:103
case controllers_JournalPublicationController_getJournalPublicationById69_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_JournalPublicationController_getJournalPublicationById69_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.JournalPublicationController]).getJournalPublicationById(id, format))
   }
}
        

// @LINE:104
case controllers_JournalPublicationController_addJournalPublication70_route(params) => {
   call { 
        controllers_JournalPublicationController_addJournalPublication70_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.JournalPublicationController]).addJournalPublication)
   }
}
        

// @LINE:105
case controllers_JournalPublicationController_updateJournalPublicationById71_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_JournalPublicationController_updateJournalPublicationById71_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.JournalPublicationController]).updateJournalPublicationById(id))
   }
}
        

// @LINE:106
case controllers_JournalPublicationController_deleteJournalPublicationById72_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_JournalPublicationController_deleteJournalPublicationById72_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.JournalPublicationController]).deleteJournalPublicationById(id))
   }
}
        

// @LINE:109
case controllers_BookPublicationController_getAllBookPublications73_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_BookPublicationController_getAllBookPublications73_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookPublicationController]).getAllBookPublications(format))
   }
}
        

// @LINE:110
case controllers_BookPublicationController_getBookPublicationById74_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_BookPublicationController_getBookPublicationById74_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookPublicationController]).getBookPublicationById(id, format))
   }
}
        

// @LINE:111
case controllers_BookPublicationController_addBookPublication75_route(params) => {
   call { 
        controllers_BookPublicationController_addBookPublication75_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookPublicationController]).addBookPublication)
   }
}
        

// @LINE:112
case controllers_BookPublicationController_updateBookPublicationById76_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_BookPublicationController_updateBookPublicationById76_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookPublicationController]).updateBookPublicationById(id))
   }
}
        

// @LINE:113
case controllers_BookPublicationController_deleteBookPublicationById77_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_BookPublicationController_deleteBookPublicationById77_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookPublicationController]).deleteBookPublicationById(id))
   }
}
        

// @LINE:116
case controllers_BookChapterPublicationController_getAllBookChapterPublications78_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_BookChapterPublicationController_getAllBookChapterPublications78_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookChapterPublicationController]).getAllBookChapterPublications(format))
   }
}
        

// @LINE:117
case controllers_BookChapterPublicationController_getBookChapterPublication79_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_BookChapterPublicationController_getBookChapterPublication79_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookChapterPublicationController]).getBookChapterPublication(id, format))
   }
}
        

// @LINE:118
case controllers_BookChapterPublicationController_addBookChapterPublication80_route(params) => {
   call { 
        controllers_BookChapterPublicationController_addBookChapterPublication80_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookChapterPublicationController]).addBookChapterPublication)
   }
}
        

// @LINE:119
case controllers_BookChapterPublicationController_updateBookChapterPublication81_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_BookChapterPublicationController_updateBookChapterPublication81_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookChapterPublicationController]).updateBookChapterPublication(id))
   }
}
        

// @LINE:120
case controllers_BookChapterPublicationController_deleteBookChapterPublication82_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_BookChapterPublicationController_deleteBookChapterPublication82_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.BookChapterPublicationController]).deleteBookChapterPublication(id))
   }
}
        

// @LINE:123
case controllers_ConferencePublicationController_getAllConferencePublications83_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_ConferencePublicationController_getAllConferencePublications83_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ConferencePublicationController]).getAllConferencePublications(format))
   }
}
        

// @LINE:124
case controllers_ConferencePublicationController_getConferencePublication84_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_ConferencePublicationController_getConferencePublication84_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ConferencePublicationController]).getConferencePublication(id, format))
   }
}
        

// @LINE:125
case controllers_ConferencePublicationController_addConferencePublication85_route(params) => {
   call { 
        controllers_ConferencePublicationController_addConferencePublication85_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ConferencePublicationController]).addConferencePublication)
   }
}
        

// @LINE:126
case controllers_ConferencePublicationController_updateConferencePublication86_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_ConferencePublicationController_updateConferencePublication86_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ConferencePublicationController]).updateConferencePublication(id))
   }
}
        

// @LINE:127
case controllers_ConferencePublicationController_deleteConferencePublication87_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_ConferencePublicationController_deleteConferencePublication87_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.ConferencePublicationController]).deleteConferencePublication(id))
   }
}
        

// @LINE:130
case controllers_UserController_getUser88_route(params) => {
   call(params.fromPath[Long]("id", None), Param[String]("format", Right("json"))) { (id, format) =>
        controllers_UserController_getUser88_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).getUser(id, format))
   }
}
        

// @LINE:131
case controllers_UserController_addUser89_route(params) => {
   call { 
        controllers_UserController_addUser89_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).addUser)
   }
}
        

// @LINE:132
case controllers_UserController_updateUser90_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_UserController_updateUser90_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).updateUser(id))
   }
}
        

// @LINE:133
case controllers_UserController_deleteUser91_route(params) => {
   call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_UserController_deleteUser91_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).deleteUser(id))
   }
}
        

// @LINE:134
case controllers_UserController_getAllUsers92_route(params) => {
   call(Param[String]("format", Right("json"))) { (format) =>
        controllers_UserController_getAllUsers92_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).getAllUsers(format))
   }
}
        

// @LINE:135
case controllers_UserController_isUserValid93_route(params) => {
   call { 
        controllers_UserController_isUserValid93_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).isUserValid)
   }
}
        

// @LINE:136
case controllers_UserController_isEmailExisted94_route(params) => {
   call { 
        controllers_UserController_isEmailExisted94_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).isEmailExisted)
   }
}
        

// @LINE:137
case controllers_UserController_deleteUserByUserNameandPassword95_route(params) => {
   call(params.fromPath[String]("userName", None), params.fromPath[String]("password", None)) { (userName, password) =>
        controllers_UserController_deleteUserByUserNameandPassword95_invoker.call(play.api.Play.maybeApplication.map(_.global).getOrElse(play.api.DefaultGlobal).getControllerInstance(classOf[controllers.UserController]).deleteUserByUserNameandPassword(userName, password))
   }
}
...
case controllers_Assets_at96_route(params) => {
   call(Param[String]("path", Right("/public")), params.fromPath[String]("file", None)) { (path, file) =>
        controllers_Assets_at96_invoker.call(controllers.Assets.at(path, file))
   }
}
